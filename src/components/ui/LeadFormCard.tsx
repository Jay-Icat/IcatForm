...
export function LeadFormCard() {
  ...
  return (
    <div className="relative z-10 flex items-center justify-center h-full max-h-[100dvh] px-3 sm:px-4 py-4 max-w-lg mx-auto w-full [perspective:1200px] overflow-hidden">
      
      {/* 3D Floating Amoeba Form Container */}
      <motion.div
        ref={cardRef}
        ...
        className="relative w-full max-h-[90dvh] overflow-y-auto rounded-3xl transition-transform duration-200 ease-out custom-scrollbar"
      >
        {/* Animated Amoeba Fluid Liquid Border Aura */}
        <div className="absolute -inset-[2px] rounded-3xl bg-gradient-to-r from-red-600 via-amber-500 to-blue-600 amoeba-aura opacity-80 blur-md pointer-events-none" />
        ...
        <div className="relative w-full glass-panel rounded-3xl p-5 sm:p-7 border border-white/20 shadow-2xl backdrop-blur-2xl amoeba-border overflow-hidden bg-slate-950/80">
          ...
          {/* Form Header */}
          <div className="text-center space-y-1.5 pb-4 border-b border-white/10 relative z-10">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-red-500/10 border border-red-500/30 text-[10px] sm:text-[11px] font-bold text-red-400 uppercase tracking-widest">
          ...
          {/* Registration Inputs */}
          <form onSubmit={handleSubmit} className="space-y-3 pt-3.5 relative z-10">
            ...
            <button
              ...
              className="w-full mt-2 btn-3d-red py-3 px-6 rounded-2xl flex items-center justify-center gap-2 text-xs sm:text-sm font-bold text-white shadow-xl cursor-pointer"
            >
